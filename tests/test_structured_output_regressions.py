        ...
        self.assertEqual(
            self._project_manifest(manifest, repo_root=repo_root, output_root=layout.root),
            {
                ...
                "current_analysis": {
                    ...
                    "label": "final",
                    "warning_count": 1,
                    "wpi_log_path": "<out>/logs/final/wpi.log",
                    "inference_dir": "<out>/inference/final",
                    "diagnostics_path": "<out>/diagnostics/final.txt",
                    "source_files_file": "<out>/logs/final/source-files.txt",
                    "app_classes_file": "<out>/logs/final/app-classes.txt",
                    "classpath_entries_file": "<out>/logs/final/classpath-entries.txt",
                    "adapter_metadata_path": "<out>/logs/final/adapter-metadata.json",
                },
                "stage_history": [
                    {
                    ...
                    },
                    {
                        ...
                        "rerun_required": False,
                        "artifacts": {
                            "log": "<out>/stages/owning_field/stage.log",
                        },
                    ...
                    },
                    {
                        "stage": "rlpatcher",
                        "changed": True,
                        "changed_files": ["src/main/java/com/arodnap/fixture/DirectLeakExample.java"],
                        "rerun_required": True,
                        "artifacts": {
                    ...
                    },
                    {
                        ...
                        "rerun_required": False,
                        "artifacts": {
                            "log": "<out>/stages/bundle/stage.log",
                            "patch": "<out>/stages/bundle/arodnap.patch",
                            "patch_manifest": "<out>/stages/bundle/patch_manifest.json",
                        },
                        "notes": [
                            "Bundled changes to 1 file(s) and verified them against the original repository.",
                        ],
                        "success": True,
                    },
                ],
    ...
    def test_baseline_repair_report_matches_structured_contract(self) -> None:
        ...
        self.assertEqual(
            self._project_report(report, repo_root=repo_root, output_root=layout.root),
            {
                ...
                "diagnostics": {
                    "final_diagnostics_path": "<out>/diagnostics/final.txt",
    ...
    def test_stage_results_match_structured_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            ),
            {
                "stage": "rlpatcher",
                "changed": True,
                "changed_files": ["src/main/java/com/arodnap/fixture/TryCatchLeakExample.java"],
                "rerun_required": True,
                "artifacts": {
                    "log": "<out>/stages/rlpatcher/stage.log",
                    "patch_manifest": "<out>/stages/rlpatcher/patch_manifest.json",
